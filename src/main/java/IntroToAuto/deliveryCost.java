...
//         driver = new SafariDriver();
    ...
    @DataProvider(name = "DeliveryCostData", parallel = false) //change to parallel = true for Task4
    ...
    public void deliveryCost(String cost, String weight, String length, String width, String height, String floor) {
        ...
        driver.findElement(By.xpath("//span[text() = 'Вартість доставки']")).click();
        ...
        Assert.assertEquals(Text,"Розрахункова вартість доставки" );
    }
